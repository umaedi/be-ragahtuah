                                ...
                                <table class="table table-bordered table-centered table-nowrap mb-0 rounded">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <textarea name="question" v-model="form.question" class="form-control" rows="3" id=""></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width:20%" class="fw-bold">Pilihan A</td>
                                            <td>
                                                <textarea name="option_1" v-model="form.option_1" class="form-control" rows="3" id=""></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width:20%" class="fw-bold">Pilihan B</td>
                                            <td>
                                                <textarea name="option_2" v-model="form.option_2" class="form-control" rows="3" id=""></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width:20%" class="fw-bold">Pilihan C</td>
                                            <td>
                                                <textarea name="option_3" v-model="form.option_3" class="form-control" rows="3" id=""></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width:20%" class="fw-bold">Pilihan D</td>
                                            <td>
                                                <textarea name="option_4" v-model="form.option_4" class="form-control" rows="3" id=""></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width:20%" class="fw-bold">Pilihan E</td>
                                            <td>
                                                <textarea name="option_5" v-model="form.option_5" class="form-control" rows="3" id=""></textarea>
                                            </td>
                                        </tr>
                                        <tr>
