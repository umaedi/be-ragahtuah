...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        //route update status login user
        Route::put('/student/update_status_login/{id}', [\App\Http\Controllers\Admin\StudentController::class, 'updateStatus']);
...
Route::prefix('student')->group(function () {
    ...
    Route::group(['middleware' => 'student'], function () {
        ...
        Route::get('/exam-confirmation', [App\Http\Controllers\Student\ExamController::class, 'confirmation'])->name('student.exams.confirmation');
        ...
        //student logout
        Route::get('/logout/{id}', \App\Http\Controllers\Student\LogoutController::class);
    });
});
